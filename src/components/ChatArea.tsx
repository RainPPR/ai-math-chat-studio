  ...
  return (
    <div className="flex-1 flex flex-col h-full relative bg-gray-900">
      ...
      {viewingContent && (
        ...
        >
          <div className="max-w-[90%] mx-auto w-full flex justify-between items-center mb-6 pb-4 border-b border-gray-800">
          ...
          <div id="print-content" className="max-w-[90%] mx-auto w-full flex-1 bg-gray-900 text-gray-100 rounded-xl shadow-xl p-8 sm:p-12 border border-gray-800 mb-8 overflow-x-auto">
